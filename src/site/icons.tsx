// Small stroke icons, drawn on a 24px grid and coloured with currentColor.
...
export const QrIcon = () => (
  <Icon>
    ...
    <path d="M14 14h3v3M21 14v.01M14 21h3M21 18v3M17 21v.01" />
  </Icon>
);
...
export const InfinityIcon = () => (
  <Icon>
    <path d="M7.5 15.5C5 15.5 3 13.9 3 12s2-3.5 4.5-3.5C11 8.5 13 15.5 16.5 15.5 19 15.5 21 13.9 21 12s-2-3.5-4.5-3.5C13 8.5 11 15.5 7.5 15.5Z" />
  </Icon>
);
